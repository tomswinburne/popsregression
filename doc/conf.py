...
html_style = "css/popsregression.css"
html_logo = "_static/img/logo.png"
# html_favicon = "_static/img/favicon.ico"
html_css_files = [
    "css/popsregression.css",
]
html_sidebars = {
    "quick_start": [],
    "user_guide": [],
...
html_theme_options = {
    "external_links": [],
    "github_url": "https://github.com/tomswinburne/POPS-Regression",
...
sphinx_gallery_conf = {
    "doc_module": "popsregression",
    "backreferences_dir": os.path.join("generated"),
    "examples_dirs": "../examples",
    "gallery_dirs": "auto_examples",
    "reference_url": {"popsregression": None},
}
